...
export const products: Product[] = [
  ...
  },
  {
    ...
    feedingIntro: [
      'Vetrofen Intense Instant is the ideal booster before, during and after intense activity. An essential in any first aid kit, horse box and tack room, Vetrofen Intense Instant can be offered the night before intense activity and on the day; as well as after exercise.',
      'Vetrofen Intense Instant can also be used to support your horse’s natural recovery process in the event of bruising, strains or injury. The palatable apple flavored formulation is easy to administer via a single serving oral syringe.',
    ],
    feedingColumns: ['Horse Size', 'Approximate Weight', 'Night Before', '2–3 Hrs Before Activity'],
    feedingValueKeys: ['nightBefore', 'preActivity'],
    feedingRows: [
