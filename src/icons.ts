...
export const icons: Record<string, string> = {
  ...
  jumping:
    '<path d="M4 19h16"/><path d="M7 16.5c1.2-2.2 2.6-3.4 4.2-3.6 1.8-.2 3.2.8 4.3 2.1"/><path d="M11.2 12.8c.4-1.6 1.4-2.8 2.8-3.2 1.5-.4 2.8.2 3.8 1.4"/><path d="m16.8 8.2 1.6-2.4"/><circle cx="18.8" cy="5.2" r="1"/>',
  dressage:
    '<path d="M5 19h14"/><path d="M8 17c.8-2.2 2-3.6 3.6-4 1.4-.3 2.6.4 3.6 1.6"/><path d="M11.2 13c.3-1.8 1.4-3 2.8-3.3 1.2-.2 2.3.4 3.2 1.5"/><path d="M15.8 9.2c.6-1.2 1.5-1.8 2.6-1.6"/><circle cx="18.6" cy="7" r=".9"/>',
  racing:
    '<path d="M3.5 18.5h17"/><path d="M5 16.5c1.5-1.8 3.2-2.8 5-2.6 1.6.2 2.8 1.2 4 2.4"/><path d="M10.5 13.8c.8-1.6 2.2-2.6 3.8-2.4 1.4.2 2.4 1.2 3.4 2.4"/><path d="m16.5 11.2 2.2-1.6"/><path d="M18.2 8.2c.8-.2 1.6.2 2 1"/>',
  western:
    '<path d="M4 19h16"/><path d="M7.5 16.8c1-2 2.4-3.2 4-3.4 1.6-.2 3 .8 4.2 2.2"/><path d="M11.5 13.2c.4-1.5 1.5-2.6 2.8-2.8 1.4-.2 2.6.6 3.6 1.8"/><path d="M15.8 9.5c.2-1 .8-1.6 1.8-1.8"/><path d="M16.8 6.2h2.6"/><path d="M18.1 6.2v1.4"/>',
  eventing:
    '<path d="M4 19h16"/><path d="M6.5 19v-2.2c0-.8.4-1.4 1.2-1.6L10 14.5"/><path d="M8.5 14c1.2-2 2.6-3.2 4.2-3.4 1.6-.2 3 .8 4.2 2.2"/><path d="M13 10.5c.5-1.4 1.6-2.4 3-2.5 1.2-.1 2.2.5 3 1.6"/><circle cx="18.8" cy="6.8" r=".9"/>',
  polo:
    '<path d="M4 19h16"/><path d="M7.5 17c1-2.1 2.4-3.4 4-3.6 1.6-.2 3 .8 4.2 2.2"/><path d="M11.5 13.2c.4-1.5 1.5-2.6 2.8-2.8 1.3-.2 2.4.5 3.4 1.6"/><path d="m16.5 10.5 3.2-4.2"/><circle cx="19.8" cy="5.8" r=".7"/>',
  carriage:
    '<path d="M3.5 18.5h17"/><circle cx="7.2" cy="16.2" r="2"/><circle cx="16.8" cy="16.2" r="2"/><path d="M5.5 14.5h13"/><path d="M7 14.5V11h10v3.5"/><path d="M9 11V8.5h6V11"/><path d="M10.5 8.5 9 6.5"/><path d="m13.5 8.5 1.5-2"/>',
  tooth:
    '<path d="M9 4.5c-1.2 0-2.1.8-2.3 1.8-.3 1.3.3 2.4 1 3.3L8.5 11v5.3c0 .7.45 1.2 1 1.2s1-.5 1-1.2V13h1v3.8c0 .7.45 1.2 1 1.2s1-.5 1-1.2V13h1v3.3c0 .7.45 1.2 1 1.2s1-.5 1-1.2V11l.8-1.4c.7-.9 1.3-2 1-3.3C18.1 5.3 17.2 4.5 16 4.5c-1 0-1.8.5-2.2 1.2C13.4 5 12.7 4.5 12 4.5c-.7 0-1.4.5-1.8 1.2C9.8 5 9.1 4.5 9 4.5Z"/>',
