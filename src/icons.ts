...
export const icons: Record<string, string> = {
  ...
  'chart-down': '<path d="M4 19h16"/><path d="M7 8v8"/><path d="M12 11v5"/><path d="M17 6v10"/><path d="m14 14 3 3 2-2"/>',
  o2: '<circle cx="12" cy="12" r="8.5"/><path d="M8.2 14.2V9.8h1.7c1 0 1.6.5 1.6 1.3 0 .7-.4 1.1-1 1.2l1.2 1.9h-1.3l-1-1.7H9.4v1.7H8.2Zm1.2-2.7h.5c.4 0 .7-.2.7-.5s-.2-.5-.7-.5h-.5v1Zm4.2 2.8c-1.3 0-2.2-.9-2.2-2.3s.9-2.3 2.2-2.3 2.2.9 2.2 2.3-.9 2.3-2.2 2.3Zm0-1.1c.6 0 1-.5 1-1.2s-.4-1.2-1-1.2-1 .5-1 1.2.4 1.2 1 1.2Z"/>',
