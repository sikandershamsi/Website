...
export const icons: Record<string, string> = {
  ...
  microscope:
    '<path d="M9 3v4"/><path d="M7.5 3h3"/><path d="M9 7c2.5 0 4.5 2.2 4.5 5S11.5 17 9 17 4.5 14.8 4.5 12 6.5 7 9 7Z"/><path d="M13.2 13.5 18 18"/><path d="M16.5 19.5h4"/><path d="M5 20h8"/>',
  ...
  'horse-solid': [
    '<path d="M9.6 11.6C10.2 9.5 12.6 8.6 15 8.7 17.2 8.8 18.8 9.7 19.2 11.3 19.6 13.1 18.2 14.8 15.8 15.3 13.2 15.9 10.6 15.1 9.8 13.6Z"/>',
    '<path d="M9.8 13.4 5.4 8.2 7.6 6.1 12.6 11Z"/>',
    '<path d="M7.8 5.4C9 6.3 9.2 8 8.2 9.1L5.2 12.3C4.5 13.1 3.3 13 2.7 12.3 2.1 11.6 2.2 10.5 2.9 9.9L6.2 6.8C6.5 5.8 7 4.9 7.8 5.4Z"/>',
    '<path d="M7 5 8.4 3.6 8.8 6.2Z"/>',
    '<path d="M18.2 10C20.2 9.2 22 8.2 23.4 6.8L23.9 8.6C22.4 10.2 20.4 11.4 18.4 12.2Z"/>',
    '<path d="M17.6 13.2C18.7 13.9 19.6 15 20.2 16.3L21.9 19.7 20.3 20.4 18.6 17C18.1 16 17.3 15.2 16.3 14.6Z"/>',
    '<path d="M14.6 14.6 16.4 15 15.9 17.2 16.5 19.9 14.9 20.2 14 17.3Z"/>',
    '<path d="M10.2 13.4 11.8 14.7 9.2 17 6.6 20 5.2 18.9 7.9 15.9Z"/>',
    '<path d="M12 14.9 13.7 15.1 12.9 17.2 13.5 19.9 12 20.1 11.2 17.2Z"/>',
  ].join(''),
  gallop:
    '<path d="M4 14c1.2-1.8 2.8-3 4.6-3.2.8-.8 1.8-1.4 3-1.5.6-.9 1.6-1.5 2.8-1.5 1 0 1.8.4 2.4 1l1.8.3c1 .2 1.7 1 1.7 2v1.2l1.5.8c.7.4.7 1.4.1 1.9l-1.2.9v1.4c0 .6-.5 1-1.1 1h-.8l-.6 2.2h-1.5l.4-2.2h-1.2l-.7 2.2H13l.5-2.2h-.9c-.7 0-1.3-.5-1.4-1.2L11 15H8.8l-.8 2.3H6.5l.9-2.5C6.2 14.5 5 14.4 4 14Z"/>',
  jumping:
  ...
  'heart-pulse':
    '<path d="M12 20s-7-4.4-9.2-8.2C1 9.2 2.2 6 5.4 6c1.9 0 3.1 1.1 3.8 2.1C10 7.1 11.2 6 13.1 6c3.2 0 4.4 3.2 2.6 5.8C19 15.6 12 20 12 20Z"/><path d="M4.5 12h2.2l1.3-2.2 1.8 4.2L12 12h3"/>',
  'shield-cross':
    '<path d="M12 3l7 3v6c0 4.8-3 8.4-7 9-4-.6-7-4.2-7-9V6l7-3Z"/><path d="M12 9v6"/><path d="M9 12h6"/>',
  ...
  gauge:
    '<path d="M5.5 16.5a8 8 0 1 1 13 0"/><path d="M12 15.5 15.2 10"/><circle cx="12" cy="15.5" r="1.2"/><path d="M4 19h16"/>',
  'chart-down': '<path d="M4 19h16"/><path d="M7 7v9"/><path d="M12 10v6"/><path d="M17 5v11"/><path d="m14 15 3 3 3-3"/>',
  o2: [
    '<circle cx="12" cy="12" r="9"/>',
    '<path d="M7.4 15.2V8.8h2.3c1.45 0 2.35.75 2.35 1.95 0 .95-.55 1.6-1.35 1.8l1.55 2.65h-1.7l-1.35-2.4H8.85v2.4H7.4Zm1.45-3.75h.75c.55 0 .9-.3.9-.75s-.35-.75-.9-.75h-.75v1.5Z"/>',
    '<path d="M14.35 15.2c-1.7 0-2.85-1.2-2.85-3s1.15-3 2.85-3 2.85 1.2 2.85 3-1.15 3-2.85 3Zm0-1.45c.8 0 1.3-.65 1.3-1.55s-.5-1.55-1.3-1.55-1.3.65-1.3 1.55.5 1.55 1.3 1.55Z"/>',
  ].join(''),
  molecule: '<circle cx="12" cy="12" r="2.2"/><circle cx="5.5" cy="7.5" r="1.7"/><circle cx="18.5" cy="7.5" r="1.7"/><circle cx="5.5" cy="16.5" r="1.7"/><circle cx="18.5" cy="16.5" r="1.7"/><path d="m7 8.5 3.2 2.2"/><path d="m13.8 10.7 3.2-2.2"/><path d="m7 15.5 3.2-2.2"/><path d="m13.8 13.3 3.2 2.2"/>',
  flag: '<path d="M5 21V4"/><path d="M5 4h10l-2 3.5L15 11H5"/>',
  alert: '<path d="M12 3 2.5 19h19L12 3Z"/><path d="M12 9v5"/><path d="M12 16.5h.01"/>',
  'alert-solid':
    '<path d="M12 2.6 1.7 19.9c-.3.5.1 1.1.7 1.1h19.2c.6 0 1-.6.7-1.1L12 2.6Z"/><path fill="#0d1b2e" d="M11 8.8h2l-.3 5.6h-1.4z"/><circle fill="#0d1b2e" cx="12" cy="17.2" r="1"/>',
  ...
  'moon-ring':
    '<circle cx="12" cy="12" r="10.2" stroke-dasharray="1.3 2.7"/><path d="M14.4 6.3a6.2 6.2 0 1 0 0 11.4 7 7 0 0 1 0-11.4Z"/>',
  ...
  'chart-dollar':
    '<path d="M5 19h14"/><path d="M7 16V11"/><path d="M11 16V8"/><path d="M15 16v-3"/><path d="M14 7.5h3.2"/><path d="M15.6 5.8v4.2"/><path d="m17.2 9.2 2.3 2.3"/><path d="M19.5 9.2v2.6h-2.6"/>',
  'horse-clock':
    '<path d="M3.8 14.2c0-3.2 2.2-5.8 5-5.8 1.2 0 2.2.4 3 1.1.7-.9 1.7-1.4 2.9-1.4 1.4 0 2.5.7 3.1 1.8"/><path d="M4.2 14.8c.4 1.8 1.8 3 3.6 3h1.4l.6 2.4H7.8"/><path d="M11.2 9.8c.3-1.1 1.1-1.9 2.2-1.9"/><circle cx="17.2" cy="15.2" r="4.2"/><path d="M17.2 13.2v2.2l1.4.8"/>',
  'trend-down': '<path d="M4 7 10 13l3-3 7 7"/><path d="M17 10v7h-7"/>',
  'dollar-down': '<circle cx="12" cy="12" r="9"/><path d="M12 7v10"/><path d="M9.5 15c0 1.1 1.1 2 2.5 2s2.5-.9 2.5-2c0-3-5-2-5-5 0-1.1 1.1-2 2.5-2s2.5.9 2.5 2"/><path d="m16.5 16.5 2.2 2.2"/><path d="M18.7 16.2v2.5h-2.5"/>',
  ...
  cells:
    '<circle cx="8.8" cy="9" r="3.6"/><circle cx="15.6" cy="12.2" r="3.6"/><circle cx="9.6" cy="16.2" r="3.6"/>',
  vessels:
    '<path d="M12 21V8"/><path d="M12 8c-1.5-1.3-2.3-2.9-2.5-4.8"/><path d="M12 8c1.5-1.3 2.3-2.9 2.5-4.8"/><path d="M12 12.6c-2 0-3.4-1-4.4-2.5"/><path d="M12 12.6c2 0 3.4-1 4.4-2.5"/><path d="M12 17c-2.7 0-4.6-1.3-5.9-3.2"/><path d="M12 17c2.7 0 4.6-1.3 5.9-3.2"/>',
  fibers:
    '<path d="M5 6.5c2.6-1.4 5-1.4 7 0s4.4 1.4 7 0"/><path d="M5 11c2.6-1.4 5-1.4 7 0s4.4 1.4 7 0"/><path d="M5 15.5c2.6-1.4 5-1.4 7 0s4.4 1.4 7 0"/><path d="M5 20c2.6-1.4 5-1.4 7 0s4.4 1.4 7 0"/>',
};
...
export function renderIcon(name: string, className = 'w-6 h-6'): string {
  ...
  if (name.endsWith('-solid') && icons[name]) {
    return `<svg class="${className}" viewBox="0 0 24 24" fill="currentColor" stroke="none" aria-hidden="true">${icons[name]}</svg>`;
  }
